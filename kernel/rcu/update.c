...
static bool __read_mostly rcu_boot_ended ;
...
int __read_mostly rcu_cpu_stall_ftrace_dump ;
module_param(rcu_cpu_stall_ftrace_dump, int, 0644);
int __read_mostly rcu_cpu_stall_suppress ; // !0 = suppress stall warnings.
EXPORT_SYMBOL_GPL(rcu_cpu_stall_suppress);
module_param(rcu_cpu_stall_suppress, int, 0644);
int __read_mostly rcu_cpu_stall_timeout  = CONFIG_RCU_CPU_STALL_TIMEOUT;
module_param(rcu_cpu_stall_timeout, int, 0644);
#endif /* #ifdef CONFIG_RCU_STALL_COMMON */

// Suppress boot-time RCU CPU stall warnings and rcutorture writer stall
// warnings.  Also used by rcutorture even if stall warnings are excluded.
int __read_mostly rcu_cpu_stall_suppress_at_boot ; // !0 = suppress boot stalls.
