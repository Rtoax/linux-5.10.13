...
int __read_mostly rcu_num_lvls  = RCU_NUM_LVLS;
/* Number of rcu_nodes at specified level. */
int num_rcu_lvl[] = NUM_RCU_LVL_INIT;
int __read_mostly rcu_num_nodes  = NUM_RCU_NODES; /* Total # rcu_nodes in use. */
 ...
 * a time.
 */
static int __read_mostly rcu_scheduler_fully_active ;
...
/*
 * Compute the rcu_node tree geometry(几何学) from kernel parameters.  This cannot
...
static void __init rcu_init_geometry(void)
{
	 ...
	 */
	//calculation of the `jiffies` till to the first and next `fqs` which is `force-quiescent-state`
	 ...
	 */
    //compute the number of nodes, that an `rcu_node` tree can handle with the given number of levels
    ...
    //calculate the number of rcu_nodes at each level of the tree in the [loop]
