...
static char __initdata trace_boot_options_buf[MAX_TRACER_SIZE] ;
...
static struct trace_export __rcu __read_mostly *ftrace_exports_list ;
...
static atomic_t __read_mostly trace_record_taskinfo_disabled ;
 ...
 */
int tracing_init_dentry(void)   // /sys/kernel/debug/tracing ??
{
	struct trace_array *tr = &global_trace;
