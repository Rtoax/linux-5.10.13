...
static struct tracer __read_mostly wakeup_tracer  =
{
	.name		= "wakeup",
...
static struct tracer __read_mostly wakeup_rt_tracer  =
{
	.name		= "wakeup_rt",
...
static struct tracer __read_mostly wakeup_dl_tracer  =
{
	.name		= "wakeup_dl",
