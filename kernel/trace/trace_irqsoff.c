...
static struct trace_array		__read_mostly *irqsoff_trace ;
...
static int __read_mostly trace_type ;
...
static struct tracer __read_mostly irqsoff_tracer  =
{
	.name		= "irqsoff",
...
static struct tracer __read_mostly preemptoff_tracer  =
{
	.name		= "preemptoff",
