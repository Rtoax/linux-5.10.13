...
DO: reoptimize others after unoptimized this probe */
}
...
static struct ftrace_ops __read_mostly kprobe_ftrace_ops  = {
	.func = kprobe_ftrace_handler,
	.flags = FTRACE_OPS_FL_SAVE_REGS,
};

static struct ftrace_ops __read_mostly kprobe_ipmodify_ops  = {
	.func = kprobe_ftrace_handler,
...
dify ? &kprobe_ipmodify_ops : &kprobe_ftrace_ops,
		ipmodify ? &kprobe_ipmodify_enabled : &kprobe_ftrace_enabled);
}
...
static int __init debugfs_kprobe_init(void)
{
	...
	dir = debugfs_create_dir("kprobes", NULL);  /* /sys/kernel/debug/kprobes/ */

	debugfs_create_file("list", 0400, dir, NULL, &kprobes_fops);    /* /sys/kernel/debug/kprobes/list */

	debugfs_create_file("enabled", 0600, dir, &value, &fops_kp);    /* /sys/kernel/debug/kprobes/enable */

	debugfs_create_file("blacklist", 0400, dir, NULL,   /* /sys/kernel/debug/kprobes/blacklist  */
