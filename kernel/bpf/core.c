...
int __read_mostly bpf_jit_enable    = IS_BUILTIN(CONFIG_BPF_JIT_DEFAULT_ON);
int __read_mostly bpf_jit_kallsyms  = IS_BUILTIN(CONFIG_BPF_JIT_DEFAULT_ON);
int __read_mostly bpf_jit_harden   ;
long __read_mostly bpf_jit_limit   ;
...
static struct latch_tree_root __cacheline_aligned bpf_tree ;
