...
bool __read_mostly cgroup_debug ;
 ...
 */
static u16 __read_mostly have_fork_callback ;
static u16 __read_mostly have_exit_callback ;
 ...
 */
struct css_set init_css_set = {/* cgroup subsystem state */
...
static bool __read_mostly cgroup_sk_alloc_disabled ;
...
static struct attribute *cgroup_sysfs_attrs[] = {   /* 权限 */
...
subsys_initcall(cgroup_sysfs_init); /*cgroup sysfs 初始化  */
