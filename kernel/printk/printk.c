...
atomic_t __read_mostly ignore_console_lock_warning  = ATOMIC_INIT(0);
...
void __init setup_log_buf(int early)    /*  */
{
	...
	if (!early && !new_log_buf_len)
		log_buf_add_cpu(); //increase size of the buffer for every CPU
...
int __read_mostly printk_delay_msec ;
