...
struct kmem_cache __read_mostly*fanotify_mark_cache ;
struct kmem_cache __read_mostly*fanotify_fid_event_cachep ;
struct kmem_cache __read_mostly*fanotify_path_event_cachep ;
struct kmem_cache __read_mostly*fanotify_perm_event_cachep ;
