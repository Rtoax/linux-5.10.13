...
static struct notifier_block __meminitdata kcore_callback_nb  = {
 ...
 * direct-map area. We need to create special TEXT section. $ sudo objdump -a /proc/kcore
 */
...
fs_initcall(proc_kcore_init);   /* $ sudo objdump -a /proc/kcore */
