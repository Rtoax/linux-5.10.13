...
static char __initdata nfs_root_parms[NFS_MAXPATHLEN + 1]  = "";

/* Text-based mount options passed to super.c */
static char __initdata nfs_root_options[256]  = NFS_DEF_OPTIONS;

/* Address of NFS server */
static __be32 __initdata servaddr  = htonl(INADDR_NONE);

/* Name of directory to mount */
static char __initdata nfs_export_path[NFS_MAXPATHLEN + 1]  = "";

/* server:export path string passed to super.c */
static char __initdata nfs_root_device[NFS_MAXPATHLEN + 1]  = "";
