...
struct kmem_cache __read_mostly*gfs2_glock_cachep ;
struct kmem_cache __read_mostly*gfs2_glock_aspace_cachep ;
struct kmem_cache __read_mostly *gfs2_inode_cachep ;
struct kmem_cache __read_mostly*gfs2_bufdata_cachep ;
struct kmem_cache __read_mostly*gfs2_rgrpd_cachep ;
struct kmem_cache __read_mostly*gfs2_quotad_cachep ;
struct kmem_cache __read_mostly*gfs2_qadata_cachep ;
struct kmem_cache __read_mostly*gfs2_trans_cachep ;
mempool_t __read_mostly*gfs2_page_pool ;
