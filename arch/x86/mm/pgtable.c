...
void __init pgtable_cache_init(void)    /* 一级页表内存分配 */
{
	/*
...
//gets the virtual address of the given `fixed_addresses` index
...
//makes value of `Page Table Entry` from the given physical address
