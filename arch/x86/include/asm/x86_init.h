...
struct x86_init_irqs {
	...
	pirq_domain_t (*create_pci_msi_domain)(void);
};
typedef struct irq_domain * pirq_domain_t;
/**
 ...
 */
struct x86_legacy_devices { /* legacy:（计算机系统或产品）已停产的 */
	int pnpbios;
};
 ...
 */
struct x86_legacy_features {    /* legacy:（计算机系统或产品）已停产的 */
