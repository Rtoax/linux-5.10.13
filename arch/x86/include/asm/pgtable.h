 ...
 */
#define PTI_PGTABLE_SWITCH_BIT	PAGE_SHIFT/* 12=4K */
 ...
 */
static inline void clone_pgd_range(pgd_t *dst, pgd_t *src, int count)/* 拷贝页表 */
{
	memcpy(dst, src, count * sizeof(pgd_t));
#ifdef CONFIG_PAGE_TABLE_ISOLATION/* 页表隔离 */
	if (!static_cpu_has(X86_FEATURE_PTI))
		return;
	/* Clone the user space pgd as well *//* 用户空间 页表 */
