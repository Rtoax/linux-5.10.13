 ...
 * para-virtualization: 半虚拟化 those hooks are defined here. */
...
static inline void __flush_tlb_local(void)/* 刷新本地 TLB */
{
	PVOP_VCALL0(mmu.flush_tlb_user);
}

static inline void __flush_tlb_global(void)/* 刷新 TLB */
{
	PVOP_VCALL0(mmu.flush_tlb_kernel);/* mmu 操作 */
}
...
static inline void write_cr3(unsigned long x)/* 写入 CR3 */
{
	PVOP_VCALL1(mmu.write_cr3, x);/* TODO */
}
