...
unsigned int __ro_after_init boot_cpu_physical_apicid  = -1U;
EXPORT_SYMBOL_GPL(boot_cpu_physical_apicid);

u8 __ro_after_init boot_cpu_apic_version ;
 ...
 */
static unsigned int __ro_after_init disabled_cpu_apicid  = BAD_APICID;

/*
 * This variable controls which CPUs receive external NMIs.  By default,
 * external NMIs are delivered only to the BSP.
 */
static int __ro_after_init apic_extnmi  = APIC_EXTNMI_BSP;
...
//static int __ro_after_init enabled_via_apicbase ;
 ...
 * +1=force-enable
 */
static int __initdata force_enable_local_apic ;
...
#ifdef CONFIG_X86_64
static int __initdata apic_calibrate_pmtmr ;
...
int __ro_after_init local_apic_timer_c2_ok ;
EXPORT_SYMBOL_GPL(local_apic_timer_c2_ok);

/*
 * Debug level, exported for io_apic.c
 */
int __ro_after_init apic_verbosity ;

int __ro_after_init pic_mode ;

/* Have we found an MP table */
int __ro_after_init smp_found_config ;
...
enum apic_intr_mode_id __ro_after_init apic_intr_mode ;
...
void __init init_bsp_APIC(void)
{
    ...
    //enable `APIC` of the first processor
	value |= APIC_SPIV_APIC_ENABLED;
