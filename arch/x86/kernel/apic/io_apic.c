...
int __init arch_early_ioapic_init(void) /*  */
{
	...
	if (!nr_legacy_irqs())  /* 遗留 IRQ */
		io_apic_irqs = ~0UL;/* =0xffffffffffffffff */
...
static struct irq_chip __read_mostly ioapic_chip  = {
	.name			= "IO-APIC",
...
static struct irq_chip __read_mostly ioapic_ir_chip  = {
	.name			= "IR-IO-APIC",
	.irq_startup		= startup_ioapic_irq,
	.irq_mask		= mask_ioapic_irq,
	.irq_unmask		= unmask_ioapic_irq,
...
static struct irq_chip __read_mostly lapic_chip  = {
	.name		= "local-APIC",
...
static int __initdata disable_timer_pin_1 ;
