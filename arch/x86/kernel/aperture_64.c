...
int __initdata gart_iommu_aperture_disabled ;
int __initdata gart_iommu_aperture_allowed ;

int __initdata fallback_aper_order  = 1; /* 64MB */
int __initdata fallback_aper_force ;

int __initdata fix_aperture  = 1;
...
static bool __initdata gart_fix_e820  = true;
