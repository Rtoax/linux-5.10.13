...
} __visible apm_bios_entry;
static int clock_slowed;
static int __read_mostly idle_threshold  = DEFAULT_IDLE_THRESHOLD;
static int __read_mostly idle_period  = DEFAULT_IDLE_PERIOD;
static int suspends_pending;
static int standbys_pending;
static int ignore_sys_suspend;
static int ignore_normal_resume;
static int __read_mostly bounce_interval  = DEFAULT_BOUNCE_INTERVAL;

static bool __read_mostly debug ;
static bool __read_mostly smp ;
