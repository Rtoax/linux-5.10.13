...
static int __ro_after_init msr_kvm_system_time  = MSR_KVM_SYSTEM_TIME;
static int __ro_after_init msr_kvm_wall_clock  = MSR_KVM_WALL_CLOCK;
static u64 __ro_after_init kvm_sched_clock_offset ;
