...
static bool __read_mostly disable_dac_quirk ;

const struct dma_map_ops *dma_ops;
EXPORT_SYMBOL(dma_ops);

#ifdef CONFIG_IOMMU_DEBUG
int __read_mostly panic_on_overflow  = 1;
int __read_mostly force_iommu  = 1;
#else
int __read_mostly panic_on_overflow  = 0;
int __read_mostly force_iommu  = 0;
#endif

int __read_mostly iommu_merge  = 0;
...
rootfs_initcall(pci_iommu_init);    /* iommu */
