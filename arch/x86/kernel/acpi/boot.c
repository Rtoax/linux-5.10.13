...
int __initdata acpi_fix_pin2_polarity ;

#ifdef CONFIG_X86_LOCAL_APIC
static u64 __initdata acpi_lapic_addr  = APIC_DEFAULT_PHYS_BASE;
#endif
 ...
 */
static u32 __read_mostly isa_irq_to_gsi[NR_IRQS_LEGACY]  = {
