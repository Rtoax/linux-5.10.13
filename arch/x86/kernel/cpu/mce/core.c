...
struct mce_vendor_flags __read_mostly mce_flags ;

struct mca_config __read_mostly mca_cfg  = {
	.bootlog  = -1,
	/*
	 * Tolerant levels:
...
#ifdef CONFIG_X86_64
void exc_machine_check(struct pt_regs *regs){/* 我加的 */}
/* MCE hit kernel mode */
...
static void __init mcheck_debugfs_init(void)    /*  */
{
	...
	dmce = mce_get_debugfs_dir();   /* /sys/kernel/debug/mce/ */
...
static int __init mcheck_late_init(void)
{
	...
	mcheck_debugfs_init();  /* /sys/kernel/debug/mce/ */
...
late_initcall(mcheck_late_init);    /* 内存 check */
