...
static u64 __initdata mtrr_chunk_size  = (256ULL<<20);
...
static u64 __initdata mtrr_gran_size ;
...
static unsigned long __initdata nr_mtrr_spare_reg  =
		      ...
		      unsigned long x_remove_size, int i)
{
	 ...
	 */
	static struct range __initdata range_new[RANGE_NUM] ;
