...
static struct cyc2ns_data __ro_after_init vmware_cyc2ns ;
static bool __initdata vmw_sched_clock  = true;
static DEFINE_PER_CPU_DECRYPTED(struct vmware_steal_time, vmw_steal_time) __aligned(64);
static bool has_steal_clock;
static bool __initdata steal_acc  = true; /* steal time accounting */
