...
//checks existence of `legacy` IRQs or in other words support for the [i8259]
//and setups [IRQ0] depends on this.
...
static __init void x86_late_time_init(void) /*  */
{
	 ...
	 */
	x86_init.irqs.intr_mode_select();   /* 中断模式选择 */

	/* Setup the legacy timers */
	x86_init.timers.timer_init();       /* 定时器初始化 */
