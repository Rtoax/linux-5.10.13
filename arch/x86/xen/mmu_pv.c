...
static pud_t __page_aligned_bss level3_user_vsyscall[PTRS_PER_PUD] ;
...
static phys_addr_t __initdata xen_pt_base, xen_pt_size ;
...
static unsigned char __page_aligned_bss dummy_mapping[PAGE_SIZE] ;
...
static const struct pv_mmu_ops __initconst xen_mmu_ops  = {
