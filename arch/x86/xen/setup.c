...
struct xen_memory_region __initdata xen_extra_mem[XEN_EXTRA_MEM_MAX_REGIONS] ;

/* Number of pages released from the initial allocation. */
unsigned long xen_released_pages;

/* E820 map used during setting up memory. */
static struct e820_table __initdata xen_e820_table ;
...
} __initdata  __aligned(PAGE_SIZE) xen_remap_buf ;
static unsigned long __initdata xen_remap_mfn  = INVALID_P2M_ENTRY;
...
static bool __initdata xen_512gb_limit  = IS_ENABLED(CONFIG_XEN_512GB);
