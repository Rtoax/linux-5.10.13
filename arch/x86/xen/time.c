...
static u64 __read_mostly xen_sched_clock_offset ;
...
static struct clocksource __read_mostly xen_clocksource  = {
	.name	= "xen",
	.rating	= 400,
...
static struct clock_event_device __ro_after_init xen_timerop_clockevent  = {
	.name			= "xen",
...
static struct clock_event_device __ro_after_init xen_vcpuop_clockevent  = {
	.name = "xen",
	.features = CLOCK_EVT_FEAT_ONESHOT,
...
static const struct pv_time_ops __initconst xen_time_ops  = {
	.sched_clock = xen_sched_clock,
	.steal_clock = xen_steal_clock,
};

static struct pvclock_vsyscall_time_info __read_mostly *xen_clock ;
