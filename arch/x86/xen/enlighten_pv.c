...
static const struct pv_info __initconst xen_info  = {
	.extra_user_64bit_cs = FLAT_USER_CS64,
	.name = "Xen",
};

static const struct pv_cpu_ops __initconst xen_cpu_ops  = {
	.cpuid = xen_cpuid,
...
static const struct machine_ops __initconst xen_machine_ops  = {
	.restart = xen_restart,
