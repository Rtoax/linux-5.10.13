 ...
 */
static u64 __read_mostly intel_perfmon_event_map[PERF_COUNT_HW_MAX]  =
{
...
static struct event_constraint __read_mostly intel_core_event_constraints[]  =
{
...
static struct event_constraint __read_mostly intel_core2_event_constraints[]  =
{
...
static struct event_constraint __read_mostly intel_nehalem_event_constraints[]  =
{
	FIXED_EVENT_CONSTRAINT(0x00c0, 0), /* INST_RETIRED.ANY */
	FIXED_EVENT_CONSTRAINT(0x003c, 1), /* CPU_CLK_UNHALTED.CORE */
	FIXED_EVENT_CONSTRAINT(0x0300, 2), /* CPU_CLK_UNHALTED.REF */
...
static struct extra_reg __read_mostly intel_nehalem_extra_regs[]  =
{
...
static struct event_constraint __read_mostly intel_westmere_event_constraints[]  =
{
	FIXED_EVENT_CONSTRAINT(0x00c0, 0), /* INST_RETIRED.ANY */
	FIXED_EVENT_CONSTRAINT(0x003c, 1), /* CPU_CLK_UNHALTED.CORE */
	FIXED_EVENT_CONSTRAINT(0x0300, 2), /* CPU_CLK_UNHALTED.REF */
...
static struct event_constraint __read_mostly intel_snb_event_constraints[]  =
{
	FIXED_EVENT_CONSTRAINT(0x00c0, 0), /* INST_RETIRED.ANY */
	FIXED_EVENT_CONSTRAINT(0x003c, 1), /* CPU_CLK_UNHALTED.CORE */
	FIXED_EVENT_CONSTRAINT(0x0300, 2), /* CPU_CLK_UNHALTED.REF */
...
static struct event_constraint __read_mostly intel_ivb_event_constraints[]  =
{
	FIXED_EVENT_CONSTRAINT(0x00c0, 0), /* INST_RETIRED.ANY */
	FIXED_EVENT_CONSTRAINT(0x003c, 1), /* CPU_CLK_UNHALTED.CORE */
	FIXED_EVENT_CONSTRAINT(0x0300, 2), /* CPU_CLK_UNHALTED.REF */
...
static struct extra_reg __read_mostly intel_westmere_extra_regs[]  =
{
	/* must define OFFCORE_RSP_X first, see intel_fixup_er() */
	INTEL_UEVENT_EXTRA_REG(0x01b7, MSR_OFFCORE_RSP_0, 0xffff, RSP_0),
...
static struct event_constraint __read_mostly intel_v1_event_constraints[]  =
{
	EVENT_CONSTRAINT_END
};

static struct event_constraint __read_mostly intel_gen_event_constraints[]  =
{
	FIXED_EVENT_CONSTRAINT(0x00c0, 0), /* INST_RETIRED.ANY */
	FIXED_EVENT_CONSTRAINT(0x003c, 1), /* CPU_CLK_UNHALTED.CORE */
	FIXED_EVENT_CONSTRAINT(0x0300, 2), /* CPU_CLK_UNHALTED.REF */
...
static struct event_constraint __read_mostly intel_slm_event_constraints[]  =
{
	FIXED_EVENT_CONSTRAINT(0x00c0, 0), /* INST_RETIRED.ANY */
	FIXED_EVENT_CONSTRAINT(0x003c, 1), /* CPU_CLK_UNHALTED.CORE */
...
static struct extra_reg __read_mostly intel_knl_extra_regs[]  = {
...
static struct extra_reg __read_mostly intel_snb_extra_regs[]  = {
	/* must define OFFCORE_RSP_X first, see intel_fixup_er() */
...
static struct extra_reg __read_mostly intel_snbep_extra_regs[]  = {
	/* must define OFFCORE_RSP_X first, see intel_fixup_er() */
...
static struct extra_reg __read_mostly intel_skl_extra_regs[]  = {
	INTEL_UEVENT_EXTRA_REG(0x01b7, MSR_OFFCORE_RSP_0, 0x3fffff8fffull, RSP_0),
	INTEL_UEVENT_EXTRA_REG(0x01bb, MSR_OFFCORE_RSP_1, 0x3fffff8fffull, RSP_1),
	INTEL_UEVENT_PEBS_LDLAT_EXTRA_REG(0x01cd),
	/*
...
static struct extra_reg __read_mostly intel_icl_extra_regs[]  = {
...
static struct extra_reg __read_mostly intel_slm_extra_regs[]  =
{
	/* must define OFFCORE_RSP_X first, see intel_fixup_er() */
...
static struct extra_reg __read_mostly intel_glm_extra_regs[]  = {
	/* must define OFFCORE_RSP_X first, see intel_fixup_er() */
...
static struct extra_reg __read_mostly intel_tnt_extra_regs[]  = {
	/* must define OFFCORE_RSP_X first, see intel_fixup_er() */
...
static const struct { int id; char *name; } __initconst intel_arch_events_map[]  = {
