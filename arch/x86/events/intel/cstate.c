...
static const struct cstate_model __initconst nhm_cstates  = {
...
static const struct cstate_model __initconst snb_cstates  = {
	.core_events		= BIT(PERF_CSTATE_CORE_C3_RES) |
				  BIT(PERF_CSTATE_CORE_C6_RES) |
...
static const struct cstate_model __initconst hswult_cstates  = {
	.core_events		= BIT(PERF_CSTATE_CORE_C3_RES) |
				  BIT(PERF_CSTATE_CORE_C6_RES) |
				  BIT(PERF_CSTATE_CORE_C7_RES),
...
static const struct cstate_model __initconst cnl_cstates  = {
...
static const struct cstate_model __initconst icl_cstates  = {
...
static const struct cstate_model __initconst slm_cstates  = {
	.core_events		= BIT(PERF_CSTATE_CORE_C1_RES) |
				  BIT(PERF_CSTATE_CORE_C6_RES),
...
static const struct cstate_model __initconst knl_cstates  = {
	.core_events		= BIT(PERF_CSTATE_CORE_C6_RES),
...
static const struct cstate_model __initconst glm_cstates  = {
	.core_events		= BIT(PERF_CSTATE_CORE_C1_RES) |
				  BIT(PERF_CSTATE_CORE_C3_RES) |
				  BIT(PERF_CSTATE_CORE_C6_RES),
...
static const struct x86_cpu_id __initconst intel_cstates_match[]  = {
