 ...
 */
static u64 __read_mostly zx_pmon_event_map[PERF_COUNT_HW_MAX]  = {
...
static struct event_constraint __read_mostly zxc_event_constraints[]  = {

	FIXED_EVENT_CONSTRAINT(0x0082, 1), /* unhalted core clock cycles */
	EVENT_CONSTRAINT_END
};

static struct event_constraint __read_mostly zxd_event_constraints[]  = {
...
static const struct { int id; char *name; } __initconst zx_arch_events_map[]  = {
