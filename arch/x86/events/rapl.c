...
static const char *const __initconst rapl_domain_names[NR_RAPL_DOMAINS]  = {
	"pp0-core",
	"package",
	"dram",
	"pp1-gpu",
...
struct rapl_model {
 ...
 /* 1/2^hw_unit Joule */
static int __read_mostly rapl_hw_unit[NR_RAPL_DOMAINS] ;
...
static const struct x86_cpu_id __initconst rapl_model_match[]  = {
