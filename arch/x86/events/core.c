...
static struct attribute_group __ro_after_init x86_pmu_format_group  = {
	.name = "format",
	.attrs = NULL,
};
...
static struct attribute_group __ro_after_init x86_pmu_events_group  = {
	.name = "events",
	.attrs = events_attr,
...
static struct attribute_group __ro_after_init x86_pmu_attr_group  = {
	.attrs = x86_pmu_attrs,
};
...
static struct attribute_group __ro_after_init x86_pmu_caps_group  = {
	.name = "caps",
