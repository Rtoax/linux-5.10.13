...
static bool __read_mostly lapic_timer_advance_dynamic ;
...
struct static_key_deferred __read_mostly apic_hw_disabled ;
struct static_key_deferred __read_mostly apic_sw_disabled ;
