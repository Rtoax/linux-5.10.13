...
int __ro_after_init pcpu_nr_slots ;
static size_t __ro_after_init  pcpu_chunk_struct_size ;

/* cpus with the lowest and highest unit addresses */
static unsigned int __ro_after_init pcpu_low_unit_cpu ;
static unsigned int __ro_after_init pcpu_high_unit_cpu ;

/* the address of the first chunk which starts with the kernel static area */
void __ro_after_init *pcpu_base_addr ;
EXPORT_SYMBOL_GPL(pcpu_base_addr);

static const int __ro_after_init *pcpu_unit_map ;		/* cpu -> unit */
const unsigned long __ro_after_init *pcpu_unit_offsets ;	/* cpu -> unit offset */

/* group information, used for vm allocation */
static int __ro_after_init pcpu_nr_groups ;
static const unsigned long __ro_after_init *pcpu_group_offsets ;
static const size_t __ro_after_init *pcpu_group_sizes ;
 ...
 */
struct pcpu_chunk __ro_after_init *pcpu_first_chunk ;
 ...
 */
struct pcpu_chunk __ro_after_init *pcpu_reserved_chunk ;
...
static bool __read_mostly pcpu_async_enabled ;
...
const char * const __initconst pcpu_fc_names[PCPU_FC_NR]  = {
	[PCPU_FC_AUTO]	= "auto",
	[PCPU_FC_EMBED]	= "embed",
	[PCPU_FC_PAGE]	= "page",
};

enum pcpu_fc __initdata pcpu_chosen_fc  = PCPU_FC_AUTO;/* pcpu_chosen_fc 在 percpu_alloc_setup() 中设置 */
...
{
	static int __initdata group_map[NR_CPUS] ;
	static int __initdata group_cnt[NR_CPUS] ;
	const size_t static_size = __per_cpu_end - __per_cpu_start;
