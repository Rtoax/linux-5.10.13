 ...
 * scan_mutex held.
 */
static void kmemleak_scan(void)/* 检测泄漏 */
{
	unsigned long flags;
	struct kmemleak_object *object;
	int i;
 ...
 */
static void start_scan_thread(void) /* 扫描线程 */
{
	if (scan_thread)
		return;
...
void __init kmemleak_init(void)
{
	...
	jiffies_min_age = msecs_to_jiffies(MSECS_MIN_AGE);  /* 微妙 转 jiffies */
...
late_initcall(kmemleak_late_init);  /* 按需开启内存泄漏扫描线程 */