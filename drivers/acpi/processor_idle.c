...
static unsigned int __read_mostly max_cstate  = ACPI_PROCESSOR_MAX_POWER;
module_param(max_cstate, uint, 0000);
static unsigned int __read_mostly nocst ;
module_param(nocst, uint, 0000);
static int __read_mostly bm_check_disable ;
module_param(bm_check_disable, uint, 0000);

static unsigned int __read_mostly latency_factor  = 2;
