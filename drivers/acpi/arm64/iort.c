...
static struct acpi_platform_list __initdata pmcg_plat_info[]  = {
...
static const struct iort_dev_config __initconst iort_arm_smmu_v3_cfg  = {
	.name = "arm-smmu-v3",
...
static const struct iort_dev_config __initconst iort_arm_smmu_cfg  = {
	.name = "arm-smmu",
...
static const struct iort_dev_config __initconst iort_arm_smmu_v3_pmcg_cfg  = {
...
{
	static bool __initdata acs_enabled ;
