...
#define CONFIG_ACPI_CPPC_LIB        /*  */
#define CONFIG_ACPI_CPPC_LIB 1
#define CONFIG_ACPI_CPU_FREQ_PSS    /*  */
...
#define CONFIG_ACPI_HOTPLUG_IOAPIC  /*  */
#define CONFIG_ACPI_HOTPLUG_IOAPIC 1
#define CONFIG_ACPI_HOTPLUG_MEMORY  /*  */
...
#define CONFIG_ACPI_WATCHDOG        /*  */
#define CONFIG_ACPI_WATCHDOG 1
#define CONFIG_ACPI_WMI             /*  */
#define CONFIG_ACPI_WMI_MODULE 1
#define CONFIG_ACPI                 /* 高级配置与电源接口（Advanced Configuration and Power Interface） linux内核提供了两个不同的模块来实现电源管理功能,这就是apm和acpi*/
...
#define CONFIG_ARCH_PROC_KCORE_TEXT     /*  */
...
#define CONFIG_BPF_JIT          /* BPF 及时编译器 */
#define CONFIG_BPF_JIT_DEFAULT_ON 1
#define CONFIG_BPF_KPROBE_OVERRIDE  /*  */
#define CONFIG_BPF_KPROBE_OVERRIDE 1
#define CONFIG_BPF_LSM 1
#define CONFIG_BPF_LSM          /* BPF Linux Security Module */
#define CONFIG_BPF_STREAM_PARSER/*  */
#define CONFIG_BPF_SYSCALL 1
#define CONFIG_BPF_SYSCALL      /* bpf()系统调用 */
#define CONFIG_BQL 1
#define CONFIG_BQL              /* Byte Queue Limits (BQL),自动解决驱动队列容量问题 */
...
#define CONFIG_DEBUG_BOOT_PARAMS        /*  */
...
#define CONFIG_MEMCG            /* memory cgroup */
#define CONFIG_MEMCG_SWAP       /*  */
...
#define CONFIG_MEMORY_HOTPLUG_DEFAULT_ONLINE    /*  */
#define CONFIG_MEMORY_HOTPLUG_DEFAULT_ONLINE 1
#define CONFIG_MEMORY_HOTPLUG_SPARSE    /*  */
...
#define CONFIG_NEED_MULTIPLE_NODES  /*  */
...
#define CONFIG_NET_NS           /* net namespace */
...
#define CONFIG_PERF_EVENTS      /* perf_event */
...
#define CONFIG_SCSI_CONSTANTS   /* SCSI:Small Computer System Interface 小型计算机系统接口 */
...
#define CONFIG_SOCK_CGROUP_DATA /*  */
...
#define CONFIG_STACKPROTECTOR   /* 栈保护 */
...
#define CONFIG_STRICT_KERNEL_RWX    /*  */
#define CONFIG_STRICT_KERNEL_RWX 1
#define CONFIG_STRICT_MODULE_RWX    /*  */
...
#define CONFIG_SWIOTLB          /* 纯软件的地址映射技术，为寻址能力受限的 DMA 提供软件上的地址映射 */
...
#define CONFIG_TASKS_RCU_GENERIC
...
#define CONFIG_THERMAL          /* thermal:防寒保暖 */
...
#define CONFIG_THP_SWAP         /*  */
#define CONFIG_THP_SWAP 1
#define CONFIG_THREAD_INFO_IN_TASK 1
#define CONFIG_THREAD_INFO_IN_TASK  /* thread_info 在 task_struct 结构起始位置 */
...
#define CONFIG_TIME_NS          /*  */
#define CONFIG_TIME_NS 1
#define CONFIG_TIMERFD 1
#define CONFIG_TIMERFD          /* timerfd */
...
#define CONFIG_TMPFS            /* tmpfs是一种基于内存的虚拟内存文件系统，而不是块设备 */
...
#define CONFIG_TRANSPARENT_HUGEPAGE     /* 透明 hugepage */
#define CONFIG_TREE_RCU 1
#define CONFIG_TREE_SRCU        /*  */
...
#define CONFIG_UPROBE_EVENTS    /*  */
#define CONFIG_UPROBE_EVENTS 1
#define CONFIG_UPROBES 1
#define CONFIG_UPROBES          /* uprobe 事件tracer工具 */
#define CONFIG_USB              /*  */
#define CONFIG_USB 1
...
#define CONFIG_UTS_NS           /* UNIX Time-sharing System- namespace: 隔离系统 hostname 和 NIS domain name*/
...
#define CONFIG_VIRT_CPU_ACCOUNTING_GEN  /*  */
...
#define CONFIG_X86_HV_CALLBACK_VECTOR       /*  */
...
#define CONFIG_X86_IOPL_IOPERM  /* IO privilege level _ port IO permissions */
...
#define CONFIG_X86_MCE          /* Machine Check Exception (/sys/kernel/debug/mce/) */
...
#define CONFIG_XFRM             /* IPsec协议的内核实现框架，XFRM的正确读音是transform(转换);xfrm:IPv6和IPsec协议栈 可扩展安全功能框架 */
#define CONFIG_XFRM_MIGRATE     /*  */
#define CONFIG_XFRM_MIGRATE 1
#define CONFIG_XFRM_OFFLOAD     /*  */
#define CONFIG_XFRM_STATISTICS  /*  */
#define CONFIG_XFRM_STATISTICS 1
#define CONFIG_XFRM_SUB_POLICY  /*  */
#define CONFIG_XFRM_SUB_POLICY 1
#define CONFIG_XFRM_USER        /*  */
...
#define CONFIG_XPS 1
#define CONFIG_XPS              /* xps全称是Transmit Packet Steering(操纵)，针对多队列的网卡发送时的优化，当发送一个数据包的时候，它会根据cpu来选择对应的队列 */
