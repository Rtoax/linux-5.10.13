...
static unsigned __initdata total_tests ;
static unsigned __initdata failed_tests ;

static char __initdata pbl_buffer[PAGE_SIZE] ;

static const unsigned long __initconst exp1[]  = {
	BITMAP_FROM_U64(1),
	BITMAP_FROM_U64(2),
...
static const unsigned long __initconst exp2[]  = {
	BITMAP_FROM_U64(0x3333333311111111ULL),
	BITMAP_FROM_U64(0xffffffff77777777ULL),
};

/* Fibonacci sequence */
static const unsigned long __initconst exp2_to_exp3_mask[]  = {
	BITMAP_FROM_U64(0x008000020020212eULL),
};
/* exp3_0_1 = (exp2[0] & ~exp2_to_exp3_mask) | (exp2[1] & exp2_to_exp3_mask) */
static const unsigned long __initconst exp3_0_1[]  = {
	BITMAP_FROM_U64(0x33b3333311313137ULL),
};
/* exp3_1_0 = (exp2[1] & ~exp2_to_exp3_mask) | (exp2[0] & exp2_to_exp3_mask) */
static const unsigned long __initconst exp3_1_0[]  = {
...
static const struct test_bitmap_parselist __initconst parselist_tests[]  = {
...
static const unsigned long __initconst parse_test[]  = {
	BITMAP_FROM_U64(0),
	BITMAP_FROM_U64(1),
...
static const unsigned long __initconst parse_test2[]  = {
...
static const struct test_bitmap_parselist __initconst parse_tests[]  = {
...
static const unsigned char __initconst clump_exp[]  = {
	0x01,	/* 1 bit set */
