...
static const struct test_string __initconst strings[]  = {
	{
		.in = "\\f\\ \\n\\r\\t\\v",
		.out = "\f\\ \n\r\t\v",
...
static const struct test_string_2 __initconst escape0[]  = {{
	.in = "\f\\ \n\r\t\v",
	.s1 = {{
		.out = "\\f\\ \\n\\r\\t\\v",
		.flags = ESCAPE_SPACE,
...
static const struct test_string_2 __initconst escape1[]  = {{
	.in = "\f\\ \n\r\t\v",
	.s1 = {{
		.out = "\f\\134\\040\n\\015\\011\v",
		.flags = ESCAPE_OCTAL,
...
static const struct test_string __initconst strings_upper[]  = {
	{
...
static const struct test_string __initconst strings_lower[]  = {
	{
		.in = "ABCDEFGH1234567890TEST",
		.out = "abcdefgh1234567890test",
	},
