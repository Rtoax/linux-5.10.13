...
static struct xbc_node __initdata *xbc_nodes ;
static int __initdata xbc_node_num ;
static char __initdata *xbc_data ;
static size_t __initdata xbc_data_size ;
static struct xbc_node __initdata *last_parent ;
static const char __initdata *xbc_err_msg ;
static int __initdata xbc_err_pos ;
static int __initdata open_brace[XBC_DEPTH_MAX] ;
static int __initdata brace_index ;
