...
void __init tomoyo_load_builtin_policy(void)
{
	...
	static char __initdata tomoyo_builtin_profile[]  =
		"PROFILE_VERSION=20150505\n"
		"0-CONFIG={ mode=learning grant_log=no reject_log=yes }\n";
	static char __initdata tomoyo_builtin_exception_policy[]  =
		"aggregator proc:/self/exe /proc/self/exe\n";
	static char __initdata tomoyo_builtin_domain_policy[]  = "";
	static char __initdata tomoyo_builtin_manager[]  = "";
	static char __initdata tomoyo_builtin_stat[]  = "";
#else
	/*
