...
static int __ro_after_init build_ima_appraise ;
 ...
 */
static struct ima_rule_entry __ro_after_init dont_measure_rules[]  = {
...
static struct ima_rule_entry __ro_after_init original_measurement_rules[]  = {
...
static struct ima_rule_entry __ro_after_init default_measurement_rules[]  = {
	{.action = MEASURE, .func = MMAP_CHECK, .mask = MAY_EXEC,
	 .flags = IMA_FUNC | IMA_MASK},
	{.action = MEASURE, .func = BPRM_CHECK, .mask = MAY_EXEC,
	 .flags = IMA_FUNC | IMA_MASK},
...
static struct ima_rule_entry __ro_after_init default_appraise_rules[]  = {
...
static struct ima_rule_entry __ro_after_init build_appraise_rules[]  = {
...
static struct ima_rule_entry __ro_after_init secure_boot_rules[]  = {
	{.action = APPRAISE, .func = MODULE_CHECK,
	 .flags = IMA_FUNC | IMA_DIGSIG_REQUIRED},
	{.action = APPRAISE, .func = FIRMWARE_CHECK,
	 .flags = IMA_FUNC | IMA_DIGSIG_REQUIRED},
...
static struct ima_rule_entry __ro_after_init *arch_policy_entry ;
...
static int __initdata ima_policy ;
...
static bool __initdata ima_use_appraise_tcb ;
static bool __initdata ima_use_secure_boot ;
static bool __ro_after_init ima_fail_unverifiable_sigs ;
