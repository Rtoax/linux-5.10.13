...
#define next_node(n, src) __next_node((n), &(src))  /* 下一个 NUMA NODE */
static inline int __next_node(int n, const nodemask_t *srcp)/* 使用 bitmap扫描 */
{
...
//	N_HIGH_MEMORY,		/* The node has regular or high memory */
	...
	N_GENERIC_INITIATOR,	/* The node has one or more Generic Initiators(通用启动器) */
	NR_NODE_STATES
};
