...
#undef GENL_struct
#define GENL_struct(tag_name, tag_number, s_name, s_fields)		\
static struct nla_policy __read_mostly s_name ## _nl_policy[]  =		\
{ s_fields };
...
static struct genl_ops __read_mostly ZZZ_genl_ops[]  = {
#include GENL_MAGIC_INCLUDE_FILE
};
...
static struct genl_family __ro_after_init ZZZ_genl_family  = {
