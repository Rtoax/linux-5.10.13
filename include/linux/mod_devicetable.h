...
/* dmi *//* DMI - Desktop Management Interface 桌面管理接口 */
enum dmi_field {
	DMI_NONE,
	DMI_BIOS_VENDOR,
	DMI_BIOS_VERSION,
	...
	DMI_SYS_VENDOR,
	DMI_PRODUCT_NAME,   /* 产品名称 */
	DMI_PRODUCT_VERSION,
	DMI_PRODUCT_SERIAL,
	DMI_PRODUCT_UUID,
	DMI_PRODUCT_SKU,
	DMI_PRODUCT_FAMILY,
	DMI_BOARD_VENDOR,   /* 板卡厂商 */
	DMI_BOARD_NAME,     /* 板卡名称 */
	DMI_BOARD_VERSION,
	DMI_BOARD_SERIAL,
	DMI_BOARD_ASSET_TAG,
...
struct dmi_strmatch {   /* (Desktop Management Interface) */
	unsigned char slot:7;
	unsigned char exact_match:1;
	char substr[79];
};

struct dmi_system_id {  /* 桌面管理接口(Desktop Management Interface) */
