...
enum sock_type {
	...
	SOCK_SEQPACKET	= 5,/* Provides a sequenced, reliable, two-way connection-based data transmission
	                        path for datagrams of fixed maximum length; a consumer is required to read
	                        an entire packet with each input system call. */
	SOCK_DCCP	= 6,    /* Datagram Congestion Control Protocol 数据报拥塞控制协议 */
	SOCK_PACKET	= 10,   /* Obsolete and should not be used in new programs; see packet(7) */
};
