 ...
 */
#if __GNUC__ == 4 && __GNUC_MINOR__ == 9    /* gcc-4.9 */
...
/* ffffffff83e778c0 - ffffffff83e7b020 */
#define FTRACE_EVENTS()	. = ALIGN(8);					\
			__start_ftrace_events = .;	    /* ffffffff83e778c0 */		\
			KEEP(*(_ftrace_events))				\
			__stop_ftrace_events = .;	    /* ffffffff83e7a7d8 */		\
			__start_ftrace_eval_maps = .;	/* ffffffff83e7a7d8 */		\
...
/* ffffffff83e7b020 - ffffffff83e7bd50 */
#define TRACE_SYSCALLS() . = ALIGN(8);					\
			 __start_syscalls_metadata = .;		/* ffffffff83e7b020 */	\
...
#define DATA_DATA							\
	...
	*(__tracepoints)						\
	...
	TRACE_PRINTKS()		/* ffffffff8365dcc8 - ffffffff8365dcc8 */					\
	BPF_RAW_TP()		/* ffffffff8365dce0 - ffffffff83662de0 */					\
	TRACEPOINT_STR()    /* ffffffff83662de0 - ffffffff83663230 */

/*
 * Data section helpers
 */
#define NOSAVE_DATA		/* ffffffff83ec9000 - ffffffff83eca000 */					\
	. = ALIGN(PAGE_SIZE);						\
	__nosave_begin = .;	/* ffffffff83ec9000 */					\
	*(.data..nosave)	/* include/linux/init.h __nosavedata */	\
	                    /* kernel/power/hibernate.c __visible int in_suspend __nosavedata; */\
	. = ALIGN(PAGE_SIZE);						\
	__nosave_end = .;   /* ffffffff83eca000 */

#define PAGE_ALIGNED_DATA(page_align)					\
	. = ALIGN(page_align);						\
	*(.data..page_aligned)		/* include/linux/linkage.h __page_aligned_data */				\
...
#define RO_DATA(align)		/* 只读数据 */					\
	...
	.rodata           : AT(ADDR(.rodata) - LOAD_OFFSET) {		\
		...
		*(__tracepoints_strings)/* Tracepoints: strings */	\
		                            ...
		                            /* include/trace/define_trace.h TRACE_EVENT_FN */ \
	}								\
									\
	...
	.builtin_fw        : AT(ADDR(.builtin_fw) - LOAD_OFFSET) {	\
		__start_builtin_fw = .;					\
		KEEP(*(.builtin_fw))		/* include/linux/firmware.h  DECLARE_BUILTIN_FIRMWARE_SIZE */	\
		                            /* include/linux/firmware.h  DECLARE_BUILTIN_FIRMWARE */	\
		__end_builtin_fw = .;					\
	}								\
	    \
	/* ffffffff82b34850 - ffffffff82b348c8 */								\
	TRACEDATA	/* arch/x86/include/asm/pm-trace.h TRACE_RESUME */	\
									\
	/* Kernel symbol table: Normal symbols */			\
	__ksymtab         : AT(ADDR(__ksymtab) - LOAD_OFFSET) {		\
		__start___ksymtab = .;					\
		KEEP(*(SORT(___ksymtab+*)))		/* include/linux/export.h  EXPORT_SYMBOL */		\
		__stop___ksymtab = .;					\
	}								\
									\
	...
	__ksymtab_gpl     : AT(ADDR(__ksymtab_gpl) - LOAD_OFFSET) {	\
		...
		KEEP(*(SORT(___ksymtab_gpl+*)))	/* include/linux/export.h  EXPORT_SYMBOL_GPL */			\
	...
	__ksymtab_unused  : AT(ADDR(__ksymtab_unused) - LOAD_OFFSET) {	\
		...
		KEEP(*(SORT(___ksymtab_unused+*)))	/* include/linux/export.h  EXPORT_UNUSED_SYMBOL */		\
	...
	__ksymtab_unused_gpl : AT(ADDR(__ksymtab_unused_gpl) - LOAD_OFFSET) { \
		...
		KEEP(*(SORT(___ksymtab_unused_gpl+*)))	/* include/linux/export.h  EXPORT_UNUSED_SYMBOL_GPL */		\
	...
	__ksymtab_gpl_future : AT(ADDR(__ksymtab_gpl_future) - LOAD_OFFSET) { \
		...
		KEEP(*(SORT(___ksymtab_gpl_future+*)))	/* include/linux/export.h  EXPORT_SYMBOL_GPL_FUTURE */		\
	...
	__kcrctab         : AT(ADDR(__kcrctab) - LOAD_OFFSET) {		\
		...
		__start___kcrctab = .;					\
		KEEP(*(SORT(___kcrctab+*)))		/* include/linux/export.h  EXPORT_SYMBOL */		\
		__stop___kcrctab = .;					\
	}								\
									\
	/* Kernel symbol table: GPL-only symbols */			\
	__kcrctab_gpl     : AT(ADDR(__kcrctab_gpl) - LOAD_OFFSET) {	\
		...
		KEEP(*(SORT(___kcrctab_gpl+*)))	/* include/linux/export.h  EXPORT_SYMBOL_GPL */			\
	...
	__kcrctab_unused  : AT(ADDR(__kcrctab_unused) - LOAD_OFFSET) {	\
		...
		KEEP(*(SORT(___kcrctab_unused+*)))/*include/linux/export.h  EXPORT_UNUSED_SYMBOL  */			\
	...
	__kcrctab_unused_gpl : AT(ADDR(__kcrctab_unused_gpl) - LOAD_OFFSET) { \
		...
		KEEP(*(SORT(___kcrctab_unused_gpl+*)))/*include/linux/export.h  EXPORT_UNUSED_SYMBOL_GPL  */			\
	...
	__kcrctab_gpl_future : AT(ADDR(__kcrctab_gpl_future) - LOAD_OFFSET) { \
		...
		KEEP(*(SORT(___kcrctab_gpl_future+*)))	/*include/linux/export.h  EXPORT_SYMBOL_GPL_FUTURE  */		\
		__stop___kcrctab_gpl_future = .;			\
	}								\
									\
	/* Kernel symbol table: strings */				\
    __ksymtab_strings : AT(ADDR(__ksymtab_strings) - LOAD_OFFSET) {	\
		*(__ksymtab_strings)	/* include/linux/export.h  __CRC_SYMBOL */				\
	}								\
									\
	/* __*init sections */						\
	__init_rodata : AT(ADDR(__init_rodata) - LOAD_OFFSET) {		\
		*(.ref.rodata)						\
		MEM_KEEP(init.rodata)		/* include/linux/init.h __MEMINITRODATA */			\
		MEM_KEEP(exit.rodata)		/* include/linux/init.h __memexitconst */			\
	}								\
									\
	/* Built-in module parameters. */				\
	__param : AT(ADDR(__param) - LOAD_OFFSET) {			\
		__start___param = .;		/* ffffffff82b8f2c8 */			\
		KEEP(*(__param))			/* kernel/module.c 	mod->kp = section_objs(info, "__param", ...) */		\
		__stop___param = .;			/* ffffffff82b923b0 */		\
	}								\
									\
	/* Built-in module versions. */					\
	__modver : AT(ADDR(__modver) - LOAD_OFFSET) {			\
		__start___modver = .;					\
		KEEP(*(__modver))		/* include/linux/module.h MODULE_VERSION */			\
		__stop___modver = .;					\
	}								\
									\
	RO_EXCEPTION_TABLE	/* *(__ex_table) */		\
	                    /* arch/x86/include/asm/asm.h _ASM_EXTABLE_HANDLE */\
	                                                                           \
	NOTES				/* include/linux/elfnote.h _ELFNOTE */	\
	...
	BTF					/* BPF Type Format (BTF)  */			\
									\
	. = ALIGN((align));						\
	__end_rodata = .;   /* ffffffff82b94000 只读数据的结束 */

/*
 * Non-instrumentable text section
 */
#define NOINSTR_TEXT	/* ffffffff81ee4328 - ffffffff81ee7c7f */						\
		ALIGN_FUNCTION();					\
		__noinstr_text_start = .;	/* ffffffff81ee4328 */			\
		*(.noinstr.text)					\
		__noinstr_text_end = .;     /* ffffffff81ee7c7f */
...
#define SCHED_TEXT	/* ffffffff81ef5fb0 - ffffffff81efde9c */\
		ALIGN_FUNCTION();					\
		__sched_text_start = .;		/* ffffffff81ef5fb0 */			\
		*(.sched.text)				/* __sched */		\
		__sched_text_end = .;       /* ffffffff81efde9c */

/* spinlock.text is aling to function alignment to secure we have same
 * address even at second ld pass when generating System.map */
#define LOCK_TEXT			/* ffffffff81efe7f8 - ffffffff81eff401 */				\
		ALIGN_FUNCTION();					\
		__lock_text_start = .;		/* ffffffff81efe7f8 */			\
		*(.spinlock.text)		/* __lockfunc */			\
		__lock_text_end = .;        /* ffffffff81eff401 */

#define CPUIDLE_TEXT	/* ffffffff81efdea0 - ffffffff81efe7f8 */	\
		ALIGN_FUNCTION();					\
		__cpuidle_text_start = .;		/* ffffffff81efdea0 */		\
		*(.cpuidle.text)				/* __cpuidle */	\
		__cpuidle_text_end = .;         /* ffffffff81efe7f8 */

#define KPROBES_TEXT				/* ffffffff81eff408 - ffffffff81eff408 */			\
		ALIGN_FUNCTION();					\
		__kprobes_text_start = .;	/* ffffffff81eff408 */			\
		*(.kprobes.text)			/* __kprobes */		\
		__kprobes_text_end = .;     /* ffffffff81eff408 */

#define ENTRY_TEXT					/* ffffffff82000000 - ffffffff820017de */		\
		ALIGN_FUNCTION();					\
		__entry_text_start = .;		/* ffffffff82000000 */			\
		*(.entry.text)				/* arch/x86/entry/entry_64.S */		\
		__entry_text_end = .;       /* ffffffff820017de */

#define IRQENTRY_TEXT							\
		ALIGN_FUNCTION();					\
		__irqentry_text_start = .;				\
		*(.irqentry.text)			/* __irq_entry */		\
		__irqentry_text_end = .;

#define SOFTIRQENTRY_TEXT		/* ffffffff82200000 - ffffffff822003d6 */				\
		ALIGN_FUNCTION();					\
		__softirqentry_text_start = .;	/* ffffffff82200000 */			\
		*(.softirqentry.text)			/* __softirq_entry */		\
		__softirqentry_text_end = .;    /* ffffffff822003d6 */

#define STATIC_CALL_TEXT			/* ffffffff822003d8 - ffffffff822018fd */			\
		ALIGN_FUNCTION();					\
		__static_call_text_start = .;	/* ffffffff822003d8 */			\
		*(.static_call.text)			/* __ARCH_DEFINE_STATIC_CALL_TRAMP static_call */		\
		__static_call_text_end = .;     /* ffffffff822018fd */

/* Section used for early init (in .S files) */
#define HEAD_TEXT  KEEP(*(.head.text))  /* __HEAD */
 ...
 * .BTF
 */
#ifdef CONFIG_DEBUG_INFO_BTF    /* BPF Type Format (BTF)  */
#define BTF								\
	...
	.BTF_ids : AT(ADDR(.BTF_ids) - LOAD_OFFSET) {			\
		*(.BTF_ids)			/* include/linux/btf_ids.h  BTF_IDS_SECTION = ".BTF_ids" */\
		                    /* tools/include/linux/btf_ids.h  BTF_IDS_SECTION = ".BTF_ids" */\
		                    /* tools/bpf/resolve_btfids/main.c BTF_IDS_SECTION = ".BTF_ids" */\
		                    \
	}
#else
...
/* ffffffff83df6ae0 - ffffffff83dfa990 */
#define KERNEL_CTORS()	. = ALIGN(8);			   \
			__ctors_start = .;		/* ffffffff83df6ae0 */   \
			KEEP(*(SORT(.ctors.*)))		   \
			KEEP(*(.ctors))			   \
...
#define INIT_DATA							\
	...
	*(.init.rodata .init.rodata.*)					\
	...
	LSM_TABLE()							\
	EARLY_LSM_TABLE()						\
	KUNIT_TABLE()       /* ffffffff83e800f0 - ffffffff83e800f0 空 */
...
#define BUG_TABLE			/* ffffffff83675580 - ffffffff836974b0 */				\
	. = ALIGN(8);							\
...
/*
ffffffff83e80138 t __setup_init_setup
ffffffff83e80168 t __setup_loglevel
ffffffff83e80300 t __setup_vdso_setup
ffffffff83e80318 t __setup_vdso32_setup
ffffffff83e80330 t __setup_vsyscall_setup

*/
/* ffffffff83e800f0 - ffffffff83e82298 */
...
/* ffffffff83e800f0 - ffffffff83e800f0 */
#define KUNIT_TABLE()							\
		. = ALIGN(8);						\
 ...
 */
#define PERCPU_INPUT(cacheline)	/* 0000000000000000 - 0000000000036000 */					\
	__per_cpu_start = .;		/* 0000000000000000 */				\
	*(.data..percpu..first)						\
	. = ALIGN(PAGE_SIZE);						\
	...
	*(.data..percpu..shared_aligned)				\
	...
	__per_cpu_end = .;          /* 0000000000036000 */
...
#define PERCPU_VADDR(cacheline, vaddr, phdr)				\
	__per_cpu_load = .;		/* ffffffff83bdc000 */				\
	.data..percpu vaddr : AT(__per_cpu_load - LOAD_OFFSET/* 0xffffffff80000000 */) {	\
	    /* 0000000000000000 - 0000000000036000 */ \
		PERCPU_INPUT(cacheline)					\
	} phdr								\
	. = __per_cpu_load + SIZEOF(.data..percpu)/* 0x36000 */;
...
#define INIT_TEXT_SECTION(inittext_align)				\
	...
	.init.text : AT(ADDR(.init.text) - LOAD_OFFSET) {		\
		_sinittext = .;		/* ffffffff83c12000 */				\
		INIT_TEXT			/* __init + __INIT */			\
		_einittext = .;		/* ffffffff83cb7eb1 */				\
	}
