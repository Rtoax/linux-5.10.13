...
static unsigned int __read_mostly pg_net_id ;
...
static int __read_mostly pg_count_d  = 1000;
static int __read_mostly pg_delay_d ;
static int __read_mostly pg_clone_skb_d  ;
static int __read_mostly debug  ;
