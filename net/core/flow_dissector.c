...
static siphash_key_t __read_mostly hashrnd ;
...
static struct flow_dissector __read_mostly flow_keys_dissector_symmetric ;
...
struct flow_dissector __read_mostly flow_keys_dissector ;
EXPORT_SYMBOL(flow_keys_dissector);

struct flow_dissector __read_mostly flow_keys_basic_dissector ;
