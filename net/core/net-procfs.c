...
extern struct list_head __read_mostly ptype_all ;
extern struct list_head __read_mostly ptype_base[PTYPE_HASH_SIZE] ;
...
static int __net_init dev_proc_net_init(struct net *net)
{
	...
	if (!proc_create_seq("softnet_stat", 0444, net->proc_net,       /* /proc/self/net/softnet_stat */
			 &softnet_seq_ops))
		goto out_dev;
	if (!proc_create_net("ptype", 0444, net->proc_net, &ptype_seq_ops,/* /proc/self/net/ptype */
			sizeof(struct seq_net_private)))
		goto out_softnet;
