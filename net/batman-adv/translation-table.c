...
static struct kmem_cache __read_mostly*batadv_tl_cache ;
static struct kmem_cache __read_mostly*batadv_tg_cache ;
static struct kmem_cache __read_mostly*batadv_tt_orig_cache ;
static struct kmem_cache __read_mostly*batadv_tt_change_cache ;
static struct kmem_cache __read_mostly*batadv_tt_req_cache ;
static struct kmem_cache __read_mostly*batadv_tt_roam_cache ;
