...
static struct proto __ro_after_init espintcp_prot ;
static struct proto_ops __ro_after_init espintcp_ops ;
...
static struct tcp_ulp_ops __read_mostly espintcp_ulp  = {
	.name = "espintcp",
	.owner = THIS_MODULE,
