...
static struct xfrm_if_cb const __rcu __read_mostly *xfrm_if_cb ;

static DEFINE_SPINLOCK(xfrm_policy_afinfo_lock);
static struct xfrm_policy_afinfo const __rcu __read_mostly *xfrm_policy_afinfo[AF_INET6 + 1]
						;

static struct kmem_cache __ro_after_init *xfrm_dst_cache ;
...
static unsigned int __read_mostly xfrm_policy_hashmax  = 1 * 1024 * 1024;
