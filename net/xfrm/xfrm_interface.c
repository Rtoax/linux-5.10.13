...
static struct rtnl_link_ops __read_mostly xfrmi_link_ops ;
static unsigned int __read_mostly xfrmi_net_id ;
...
static struct xfrm6_protocol __read_mostly xfrmi_esp6_protocol  = {
	.handler	=	xfrm6_rcv,
...
static struct xfrm6_protocol __read_mostly xfrmi_ah6_protocol  = {
	.handler	=	xfrm6_rcv,
	.input_handler	=	xfrm_input,
	.cb_handler	=	xfrmi_rcv_cb,
	.err_handler	=	xfrmi6_err,
...
static struct xfrm6_protocol __read_mostly xfrmi_ipcomp6_protocol  = {
	.handler	=	xfrm6_rcv,
	.input_handler	=	xfrm_input,
	.cb_handler	=	xfrmi_rcv_cb,
	.err_handler	=	xfrmi6_err,
...
static struct xfrm6_tunnel __read_mostly xfrmi_ipv6_handler  = {
...
static struct xfrm6_tunnel __read_mostly xfrmi_ip6ip_handler  = {
	.handler	=	xfrmi6_rcv_tunnel,
	.cb_handler	=	xfrmi_rcv_cb,
	.err_handler	=	xfrmi6_err,
	.priority	=	2,
...
static struct xfrm4_protocol __read_mostly xfrmi_esp4_protocol  = {
	.handler	=	xfrm4_rcv,
	.input_handler	=	xfrm_input,
	.cb_handler	=	xfrmi_rcv_cb,
...
static struct xfrm4_protocol __read_mostly xfrmi_ah4_protocol  = {
	.handler	=	xfrm4_rcv,
	.input_handler	=	xfrm_input,
	.cb_handler	=	xfrmi_rcv_cb,
	.err_handler	=	xfrmi4_err,
...
static struct xfrm4_protocol __read_mostly xfrmi_ipcomp4_protocol  = {
	.handler	=	xfrm4_rcv,
	.input_handler	=	xfrm_input,
	.cb_handler	=	xfrmi_rcv_cb,
	.err_handler	=	xfrmi4_err,
...
static struct xfrm_tunnel __read_mostly xfrmi_ipip_handler  = {
...
static struct xfrm_tunnel __read_mostly xfrmi_ipip6_handler  = {
	.handler	=	xfrmi4_rcv_tunnel,
	.cb_handler	=	xfrmi_rcv_cb,
	.err_handler	=	xfrmi4_err,
	.priority	=	2,
