...
static unsigned int __read_mostly brnf_net_id ;
...
static struct notifier_block __read_mostly brnf_notifier  = {
...
static struct pernet_operations __read_mostly brnf_net_ops  = {
#ifdef CONFIG_SYSCTL
	.init = brnf_init_net,
#endif
	.exit = brnf_exit_net,
