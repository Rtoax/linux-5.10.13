...
unsigned int __read_mostly ovs_net_id ;
...
static struct genl_family __ro_after_init dp_packet_genl_family  = {
...
static struct genl_family __ro_after_init dp_flow_genl_family  = {
	.hdrsize = sizeof(struct ovs_header),
...
static struct genl_family __ro_after_init dp_datapath_genl_family  = {
	.hdrsize = sizeof(struct ovs_header),
...
struct genl_family __ro_after_init dp_vport_genl_family  = {
	.hdrsize = sizeof(struct ovs_header),
