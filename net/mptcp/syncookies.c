...
static struct join_entry __cacheline_aligned_in_smp join_entries[COOKIE_JOIN_SLOTS] ;
static spinlock_t __cacheline_aligned_in_smp join_entry_locks[COOKIE_JOIN_SLOTS] ;
