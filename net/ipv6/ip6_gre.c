...
static unsigned int __read_mostly ip6gre_net_id ;
struct ip6gre_net {
...
static struct rtnl_link_ops __read_mostly ip6gre_link_ops ;
static struct rtnl_link_ops __read_mostly ip6gre_tap_ops ;
static struct rtnl_link_ops __read_mostly ip6erspan_tap_ops ;
...
static struct inet6_protocol __read_mostly ip6gre_protocol  = {
	.handler     = gre_rcv,
