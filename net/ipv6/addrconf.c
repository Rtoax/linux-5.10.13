...
static struct ipv6_devconf __read_mostly ipv6_devconf  = {
	.forwarding		= 0,
...
static struct ipv6_devconf __read_mostly ipv6_devconf_dflt  = {
	.forwarding		= 0,
	.hop_limit		= IPV6_DEFAULT_HOPLIMIT,
	.mtu6			= IPV6_MIN_MTU,
	.accept_ra		= 1,
...
static struct rtnl_af_ops __read_mostly inet6_ops  = {
	.family		  = AF_INET6,
