...
static bool check_6rd(struct ip_tunnel *tunnel, const struct in6_addr *v6dst,
		      __be32 *v4dst);
static struct rtnl_link_ops __read_mostly sit_link_ops ;

static unsigned int __read_mostly sit_net_id ;
struct sit_net {
...
static struct xfrm_tunnel __read_mostly sit_handler  = {
	.handler	=	ipip6_rcv,
	.err_handler	=	ipip6_err,
	.priority	=	1,
};

static struct xfrm_tunnel __read_mostly ipip_handler  = {
	.handler	=	ipip_rcv,
	.err_handler	=	ipip6_err,
	.priority	=	2,
};
...
#if IS_ENABLED(CONFIG_MPLS)
static struct xfrm_tunnel __read_mostly mplsip_handler  = {
	.handler	=	mplsip_rcv,
	.err_handler	=	ipip6_err,
	.priority	=	2,
};
