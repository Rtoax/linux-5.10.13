...
static struct rtnl_link_ops __read_mostly ip6_link_ops ;

static unsigned int __read_mostly ip6_tnl_net_id ;
struct ip6_tnl_net {
...
static struct xfrm6_tunnel __read_mostly ip4ip6_handler  = {
	.handler	= ip4ip6_rcv,
	.err_handler	= ip4ip6_err,
	.priority	=	1,
};

static struct xfrm6_tunnel __read_mostly ip6ip6_handler  = {
	.handler	= ip6ip6_rcv,
	.err_handler	= ip6ip6_err,
	.priority	=	1,
};

static struct xfrm6_tunnel __read_mostly mplsip6_handler  = {
	.handler	= mplsip6_rcv,
