...
const struct nf_ipv6_ops __rcu __read_mostly *nf_ipv6_ops ;
 ...
 */
struct nfnl_ct_hook __rcu __read_mostly *nfnl_ct_hook ;
EXPORT_SYMBOL_GPL(nfnl_ct_hook);

struct nf_ct_hook __rcu __read_mostly *nf_ct_hook ;
...
void __rcu __read_mostly (*ip_ct_attach)(struct sk_buff *, const struct sk_buff *)
		;
EXPORT_SYMBOL(ip_ct_attach);

struct nf_nat_hook __rcu __read_mostly *nf_nat_hook ;
