...
static unsigned int __read_mostly ip_list_tot  = 100;
static unsigned int __read_mostly ip_list_hash_size ;
static unsigned int __read_mostly ip_list_perms  = 0644;
static unsigned int __read_mostly ip_list_uid ;
static unsigned int __read_mostly ip_list_gid ;
...
static unsigned int __read_mostly ip_pkt_list_tot ;
...
static unsigned int __read_mostly recent_net_id ;
...
static u_int32_t __read_mostly hash_rnd ;
...
static struct xt_match __read_mostly recent_mt_reg[]  = {
	{
		.name       = "recent",
		.revision   = 0,
		.family     = NFPROTO_IPV4,
