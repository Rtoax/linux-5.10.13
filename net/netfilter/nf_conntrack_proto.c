...
static const struct nf_hook_ops ipv4_conntrack_ops[] = {
	{
		nf_hook_ops.hook		= ipv4_conntrack_in,
		nf_hook_ops.pf		= NFPROTO_IPV4,
		nf_hook_ops.hooknum	= NF_INET_PRE_ROUTING,
		nf_hook_ops.priority	= NF_IP_PRI_CONNTRACK,
	},
	{
		nf_hook_ops.hook		= ipv4_conntrack_local,
		nf_hook_ops.pf		= NFPROTO_IPV4,
		nf_hook_ops.hooknum	= NF_INET_LOCAL_OUT,
		nf_hook_ops.priority	= NF_IP_PRI_CONNTRACK,
	},
	{
		nf_hook_ops.hook		= ipv4_confirm,
		nf_hook_ops.pf		= NFPROTO_IPV4,
		nf_hook_ops.hooknum	= NF_INET_POST_ROUTING,
		nf_hook_ops.priority	= NF_IP_PRI_CONNTRACK_CONFIRM,
	},
	{
		nf_hook_ops.hook		= ipv4_confirm,
		nf_hook_ops.pf		= NFPROTO_IPV4,
