...
static spinlock_t __cacheline_aligned_in_smp nf_conncount_locks[CONNCOUNT_SLOTS] ;
...
static u_int32_t __read_mostly conncount_rnd ;
static struct kmem_cache __read_mostly *conncount_rb_cachep ;
static struct kmem_cache __read_mostly *conncount_conn_cachep ;
