...
static bool __read_mostly enable_hooks ;
MODULE_PARM_DESC(enable_hooks, "Always enable conntrack hooks");
module_param(enable_hooks, bool, 0000);

unsigned int __read_mostly nf_conntrack_net_id ;
...
static int __read_mostly log_invalid_proto_min ;
static int __read_mostly log_invalid_proto_max  = 255;

/* size the user *wants to set */
static unsigned int __read_mostly nf_conntrack_htable_size_user ;
