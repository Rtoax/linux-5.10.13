...
struct hlist_nulls_head __read_mostly *nf_conntrack_hash ;
...
unsigned int __read_mostly nf_conntrack_htable_size ;
EXPORT_SYMBOL_GPL(nf_conntrack_htable_size);

unsigned int __read_mostly nf_conntrack_max ;
EXPORT_SYMBOL_GPL(nf_conntrack_max);
seqcount_spinlock_t __read_mostly nf_conntrack_generation ;
static unsigned int __read_mostly nf_conntrack_hash_rnd ;
...
{
	static unsigned int __read_mostly size ;
