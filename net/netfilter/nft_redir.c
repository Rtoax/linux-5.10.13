...
static struct nft_expr_type __read_mostly nft_redir_ipv4_type  = {
	.family		= NFPROTO_IPV4,
	.name		= "redir",
...
static struct nft_expr_type __read_mostly nft_redir_ipv6_type  = {
	.family		= NFPROTO_IPV6,
	.name		= "redir",
...
static struct nft_expr_type __read_mostly nft_redir_inet_type  = {
	.family		= NFPROTO_INET,
	.name		= "redir",
