...
int __read_mostly ip_vs_conn_tab_size ;
static int __read_mostly ip_vs_conn_tab_mask ;

/*
 *  Connection hash table: for input and output packets lookups of IPVS
 */
static struct hlist_head __read_mostly *ip_vs_conn_tab ;

/*  SLAB cache for IPVS connections */
static struct kmem_cache __read_mostly *ip_vs_conn_cachep ;

/*  counter for no client port connections */
static atomic_t ip_vs_conn_no_cport_cnt = ATOMIC_INIT(0);

/* random value for IPVS connection hash */
static unsigned int __read_mostly ip_vs_conn_rnd ;
...
static struct ip_vs_aligned_lock    __cacheline_aligned
__ip_vs_conntbl_lock_array[CT_LOCKARRAY_SIZE] ;
