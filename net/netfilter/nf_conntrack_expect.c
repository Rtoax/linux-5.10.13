...
unsigned int __read_mostly nf_ct_expect_hsize ;
EXPORT_SYMBOL_GPL(nf_ct_expect_hsize);

struct hlist_head __read_mostly*nf_ct_expect_hash ;
EXPORT_SYMBOL_GPL(nf_ct_expect_hash);

unsigned int __read_mostly nf_ct_expect_max ;

static struct kmem_cache __read_mostly*nf_ct_expect_cachep ;
static unsigned int __read_mostly nf_ct_expect_hashrnd ;
