...
/* Parameters */
static unsigned int __read_mostly default_rrq_ttl  = 300;
module_param(default_rrq_ttl, uint, 0600);
MODULE_PARM_DESC(default_rrq_ttl, "use this TTL if it's missing in RRQ");

static int __read_mostly gkrouted_only  = 1;
module_param(gkrouted_only, int, 0600);
MODULE_PARM_DESC(gkrouted_only, "only accept calls from gatekeeper");

static bool __read_mostly callforward_filter  = true;
...
static struct nf_conntrack_helper __read_mostly nf_conntrack_helper_h245  = {
	.name			= "H.245",
	.me			= THIS_MODULE,
...
static struct nf_conntrack_helper __read_mostly nf_conntrack_helper_q931[]  = {
	{
		.name			= "Q.931",
		.me			= THIS_MODULE,
...
static struct nf_conntrack_helper __read_mostly nf_conntrack_helper_ras[]  = {
	{
		.name			= "RAS",
		.me			= THIS_MODULE,
		.tuple.src.l3num	= AF_INET,
