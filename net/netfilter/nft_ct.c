...
static unsigned int __read_mostly nft_ct_pcpu_template_refcnt ;
#endif
...
static struct nft_expr_type __read_mostly nft_ct_type  = {
	.name		= "ct",
...
static struct nft_expr_type __read_mostly nft_notrack_type  = {
	.name		= "notrack",
	.ops		= &nft_notrack_ops,
	.owner		= THIS_MODULE,
};
...
static struct nft_object_type __read_mostly nft_ct_timeout_obj_type  = {
...
static struct nft_object_type __read_mostly nft_ct_helper_obj_type  = {
...
static struct nft_object_type __read_mostly nft_ct_expect_obj_type  = {
