...
static unsigned int __read_mostly master_timeout  = 300;
...
unsigned int __read_mostly (*nf_nat_amanda_hook)(struct sk_buff *skb,
...
static struct nf_conntrack_helper __read_mostly amanda_helper[2]  = {
	{
		.name			= HELPER_NAME,
		.me			= THIS_MODULE,
		.help			= amanda_help,
