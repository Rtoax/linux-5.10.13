...
static unsigned int __read_mostly ip_set_net_id ;
...
static struct nfnetlink_subsystem __read_mostly ip_set_netlink_subsys  = {
	.name		= "ip_set",
...
static struct nf_sockopt_ops __read_mostly so_set  = {
	.pf		= PF_INET,
