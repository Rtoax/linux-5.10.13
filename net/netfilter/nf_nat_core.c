...
static unsigned int __read_mostly nat_net_id ;

static struct hlist_head __read_mostly*nf_nat_bysource ;
static unsigned int __read_mostly nf_nat_htable_size ;
static unsigned int __read_mostly nf_nat_hash_rnd ;
...
static struct nf_ct_ext_type __read_mostly nat_extend  = {
