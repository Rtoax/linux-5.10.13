...
static struct nft_expr_type __read_mostly nft_masq_ipv4_type  = {
	.family		= NFPROTO_IPV4,
	.name		= "masq",
...
static struct nft_expr_type __read_mostly nft_masq_ipv6_type  = {
	.family		= NFPROTO_IPV6,
	.name		= "masq",
...
static struct nft_expr_type __read_mostly nft_masq_inet_type  = {
	.family		= NFPROTO_INET,
	.name		= "masq",
