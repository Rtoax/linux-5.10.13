...
static struct rtnl_link_ops __read_mostly vti_link_ops ;

static unsigned int __read_mostly vti_net_id ;
...
static struct xfrm4_protocol __read_mostly vti_esp4_protocol  = {
...
static struct xfrm4_protocol __read_mostly vti_ah4_protocol  = {
	.handler	=	vti_rcv_proto,
	.input_handler	=	vti_input_proto,
	.cb_handler	=	vti_rcv_cb,
	.err_handler	=	vti4_err,
...
static struct xfrm4_protocol __read_mostly vti_ipcomp4_protocol  = {
	.handler	=	vti_rcv_proto,
	.input_handler	=	vti_input_proto,
	.cb_handler	=	vti_rcv_cb,
	.err_handler	=	vti4_err,
...
static struct xfrm_tunnel __read_mostly vti_ipip_handler  = {
...
#if IS_ENABLED(CONFIG_IPV6)
static struct xfrm_tunnel __read_mostly vti_ipip6_handler  = {
	.handler	=	vti_rcv_tunnel,
	.cb_handler	=	vti_rcv_cb,
	.err_handler	=	vti4_err,
	.priority	=	0,
