...
static int __read_mostly nv_pad = 10;
static int __read_mostly nv_pad_buffer  = 2;
static int __read_mostly nv_reset_period  = 5; /* in seconds */
static int __read_mostly nv_min_cwnd  = 2;
static int __read_mostly nv_cong_dec_mult  = 30 * 128 / 100; /* = 30% */
static int __read_mostly nv_ssthresh_factor  = 8; /* = 1 */
static int __read_mostly nv_rtt_factor  = 128; /* = 1/2*old + 1/2*new */
static int __read_mostly nv_loss_dec_factor  = 819; /* => 80% */
static int __read_mostly nv_cwnd_growth_rate_neg  = 8;
static int __read_mostly nv_cwnd_growth_rate_pos ; /* 0 => fixed like Reno */
static int __read_mostly nv_dec_eval_min_calls  = 60;
static int __read_mostly nv_inc_eval_min_calls  = 20;
static int __read_mostly nv_ssthresh_eval_min_calls  = 30;
static int __read_mostly nv_stop_rtt_cnt  = 10;
static int __read_mostly nv_rtt_min_cnt  = 2;
...
static struct tcp_congestion_ops __read_mostly tcpnv  = {
	.init		= tcpnv_init,
