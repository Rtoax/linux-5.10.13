 ...
 */
int __initdata ic_set_manually  = 0;		/* IPconfig parameters set manually */
...
static int __initdata ic_host_name_set ;	/* Host name set by us? */
...
static char __initdata vendor_class_identifier[253] ;

#if defined(CONFIG_IP_PNP_DHCP)
static char __initdata dhcp_client_identifier[253] ;
#endif
...
/* MTU for boot device */
static int __initdata ic_dev_mtu ;

#ifdef IPCONFIG_DYNAMIC
static DEFINE_SPINLOCK(ic_recv_lock);
static volatile int __initdata ic_got_reply ;    /* Proto(s) that replied */
#endif
#ifdef IPCONFIG_DHCP
static int __initdata ic_dhcp_msgtype ;	/* DHCP msg type received */
#endif
...
static struct ic_device __initdata *ic_first_dev ;	/* List of open device */
static struct ic_device __initdata *ic_dev ;		/* Selected device */
...
static struct packet_type __initdata rarp_packet_type  = {
...
static struct packet_type __initdata bootp_packet_type  = {
