...
static int __read_mostly ip_rt_redirect_number 	= 9;
static int __read_mostly ip_rt_redirect_load 	= HZ / 50;
static int __read_mostly ip_rt_redirect_silence = ((HZ / 50) << (9 + 1));
static int __read_mostly ip_rt_error_cost 	= HZ;
static int __read_mostly ip_rt_error_burst 	= 5 * HZ;
static int __read_mostly ip_rt_mtu_expires 	= 10 * 60 * HZ;
static u32 __read_mostly ip_rt_min_pmtu 	= 512 + 20 + 20;
static int __read_mostly ip_rt_min_advmss 	= 256;

static int __read_mostly ip_rt_gc_timeout 	= RT_GC_TIMEOUT;
...
static atomic_t __read_mostly *ip_idents ;
static u32 __read_mostly *ip_tstamps ;
