...
static struct kmem_cache  __ro_after_init *peer_cachep ;
...
int __read_mostly inet_peer_threshold  = 65536 + 128;	/* start to throw entries more
					 * aggressively at this stage */
int __read_mostly inet_peer_minttl  = 120 * HZ;	/* TTL under high load: 120 sec */
int __read_mostly inet_peer_maxttl  = 10 * 60 * HZ;	/* usual time to live: 10 min */
