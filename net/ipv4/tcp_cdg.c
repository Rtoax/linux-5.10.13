...
static int __read_mostly window  = 8;
static unsigned int __read_mostly backoff_beta  = 0.7071 * 1024; /* sqrt 0.5 */
static unsigned int __read_mostly backoff_factor  = 42;
static unsigned int __read_mostly hystart_detect  = 3;
static unsigned int __read_mostly use_ineff  = 5;
static bool __read_mostly use_shadow  = true;
static bool __read_mostly use_tolerance ;
...
static struct tcp_congestion_ops __read_mostly tcp_cdg  = {
