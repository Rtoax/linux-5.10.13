...
static struct rtnl_link_ops __read_mostly ipgre_link_ops ;
static int ipgre_tunnel_init(struct net_device *dev);
static void erspan_build_header(struct sk_buff *skb,
				u32 id, u32 index,
				bool truncate, bool is_ipv4);

static unsigned int __read_mostly ipgre_net_id ;
static unsigned int __read_mostly gre_tap_net_id ;
static unsigned int __read_mostly erspan_net_id ;
...
static struct rtnl_link_ops __read_mostly ipgre_tap_ops  = {
	.kind		= "gretap",
	.maxtype	= IFLA_GRE_MAX,
	.policy		= ipgre_policy,
	.priv_size	= sizeof(struct ip_tunnel),
...
static struct rtnl_link_ops __read_mostly erspan_link_ops  = {
	.kind		= "erspan",
	.maxtype	= IFLA_GRE_MAX,
	.policy		= ipgre_policy,
	.priv_size	= sizeof(struct ip_tunnel),
