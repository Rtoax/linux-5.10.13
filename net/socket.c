...
unsigned int __read_mostly sysctl_net_busy_read ;
unsigned int __read_mostly sysctl_net_busy_poll ;
#endif
...
static struct kmem_cache __ro_after_init *sock_inode_cachep ;
