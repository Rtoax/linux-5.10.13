...
static struct proto unix_proto = {  /* UNIX Socket 应用层和传输层的接口*/
	.name			= "UNIX",
	.owner			= THIS_MODULE,
...
//    ffff9840a74c5c00: 00000002 00000000 00000000 0002 01 51100 /var/lib/samba/private/msg.sock/2771
//    ffff984215ed3400: 00000002 00000000 00010000 0001 01 49794 public/pickup
...
static const struct net_proto_family unix_family_ops = {/* UNIX 协议族 */
	.family = PF_UNIX,
	.create = unix_create,
	.owner	= THIS_MODULE,
};
...
static int __init af_unix_init(void)    /*  */
{
	...
	rc = proto_register(&unix_proto, 1);    /* 注册协议(应用层和传输层接口)，分配 kmem_cache */
	if (rc != 0) {
...
fs_initcall(af_unix_init);/*UNIX socket  */
