...
static struct kmem_cache	__read_mostly *rpc_task_slabp ;
static struct kmem_cache	__read_mostly *rpc_buffer_slabp ;
static mempool_t	__read_mostly *rpc_task_mempool ;
static mempool_t	__read_mostly *rpc_buffer_mempool ;
 ...
 */
struct workqueue_struct __read_mostly *rpciod_workqueue ;
struct workqueue_struct __read_mostly *xprtiod_workqueue ;
