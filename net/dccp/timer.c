...
int  __read_mostly sysctl_dccp_request_retries	 = TCP_SYN_RETRIES;
int  __read_mostly sysctl_dccp_retries1		 = TCP_RETR1;
int  __read_mostly sysctl_dccp_retries2		 = TCP_RETR2;
